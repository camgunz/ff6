...
def test_monsters(rom_filename):
    rom = FF6ROM.deserialize_from_file(rom_filename)
...
def test_hp_per_level(rom_filename):
    print(FF6ROM.deserialize_from_file(rom_filename).hp_per_level)

def test_mp_per_level(rom_filename):
    print(FF6ROM.deserialize_from_file(rom_filename).mp_per_level)

def test_xp_per_level(rom_filename):
    print(FF6ROM.deserialize_from_file(rom_filename).xp_per_level)
...
def compare_roms(rom_filename):
    rom1 = FF6ROM.deserialize_from_file(rom_filename)
    rom2 = FF6ROM.deserialize_from_file(rom_filename)
    rom2.serialize()
    assert rom1 == rom2
    print('ROMs equal')
...
def test_dances(rom_filename):
    print(FF6ROM.deserialize_from_file(rom_filename).dances)
...
def test_write(rom_filename):
    rom = FF6ROM.deserialize_from_file(rom_filename)
    rom.inventory_items.black_belt.battle_power = 200
    rom.inventory_items.gem_box = rom.inventory_items.black_belt
